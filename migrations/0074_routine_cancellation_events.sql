-- 0074: add durable cancellation receipt kinds to routine_run_events (#397 Task 9).
--
-- 0073 shipped without cancellation_requested / _confirmed / _unconfirmed.
-- Do not edit applied 0073 — rebuild the events table forward-only while
