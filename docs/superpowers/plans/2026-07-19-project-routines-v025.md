...
- `migrations/0073_project_routines.sql`: Routine, run, event, action, reference, lease, uniqueness, and query indexes.
- `migrations/0074_routine_cancellation_events.sql`: forward-only cancellation event and fence upgrade.
...
**Files:**
- Create: `migrations/0073_project_routines.sql`
