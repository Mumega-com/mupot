...
| 5 | Runner onboarding (mint → check_in poll-mode → receive → report → settle) | Broken for poll-mode runners; fix open (#1494/#1514, supersedes #1501) | [05-runner-onboarding.md](./05-runner-onboarding.md) |
