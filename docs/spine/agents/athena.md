...
- **Harness (since 2026-08-08):** `prime-agent --provider opencode-go --model deepseek-v4-flash --thinking high`, tmux session `athena`, workdir `/mnt/HC_Volume_104325311/mumega.com/agents/athena`. Home dir holds CLAUDE.md, docs, qnft, scripts.
