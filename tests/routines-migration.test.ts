...
const ROUTINES_MIGRATION = '0073_project_routines.sql'
const CANCELLATION_MIGRATION = '0074_routine_cancellation_events.sql'
...
describe('0073_project_routines migration', () => {
...
describe('0074_routine_cancellation_events migration', () => {
