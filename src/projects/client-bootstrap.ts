...
export const DEFAULT_CLIENT_PROJECTS = [
  {
    ...
    slug: 'viamar',
    name: 'Viamar',
    description: 'Viamar client worker — freight and logistics surface.',
    goal: 'Keep the Viamar Cloudflare worker healthy and ship feature flights against Digidinc/viamar.',
  ...
  },
  {
    ...
    slug: 'dme',
    name: 'DME',
    description: 'Digital Marketing Experts client worker.',
    goal: 'Keep the DME Cloudflare worker healthy and ship feature flights against digidinc/dgd-dme.',
