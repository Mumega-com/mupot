...
// Exported so sibling tool modules (src/mcp/gates.ts, loops.ts, provision.ts)
// share this ONE org-admin check — MCP-side equivalent of isOrgAdmin (dashboard),
// translated from coarse session role to the capability-grant system MCP callers carry.
