...
7. SYNTHETIC COUNCIL BUS & ACK PROTOCOL
   ...
   - TO CLOSE A CHAIN with an ordinary message, put the literal marker '[no_reply]' in the body. A recipient reading 'expects_reply' will stop. Writing "chain closed" in prose does NOT work — no automated acker parses free text, and that is precisely how an observed live ack loop kept running.
