...
Operational sources are the [Cargo manifest](../Cargo.toml), [bundle script](../scripts/bundle-macos.sh), [profile repository](../src/profiles.rs) and [Keychain vault](../src/vault.rs).
